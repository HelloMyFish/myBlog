...
public class Test {
    ...
    //邮件编辑信息(仅需写上自己的)
    private static final String MAIL_FROM ="915320256@qq.com";//邮件发送人
    private static final String MAIL_FROM_PASSWORD ="exjfvckhidppbcce";//邮件发送人授权码
    ...
    private static final String MAIL_ORGANIZATION ="MyBlog.com";//邮件组织
